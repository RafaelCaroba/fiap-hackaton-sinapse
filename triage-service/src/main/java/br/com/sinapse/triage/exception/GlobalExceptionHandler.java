...
import br.com.sinapse.triage.dto.ErrorResponse.FieldError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePatientServiceUnavailable(
            PatientServiceUnavailableException ex, HttpServletRequest request) {
